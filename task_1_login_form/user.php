    ...
    <section class="vh-100" style="background-color: #eee;">
        ...
        <div class="container py-3">
            <div class="row">
                ...
                <div class="col-lg-8" style="margin-top: 230px;">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-3">
                            ...
                            <?php 
                                ...
                                <div class="d-flex justify-content-center mb-1">
                                    <a href="update.php?username='.$username.'" class="btn btn-warning">Update</a>
                                    <a href="delete.php?username='.$username.'" style="margin-left: 20px;" class="btn btn-danger">Delete</a>
                                </div>'
                            ?>
                        </div>
                    </div>
